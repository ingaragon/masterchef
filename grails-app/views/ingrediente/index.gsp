		...
		<div id="list-ingrediente" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="ingrediente.tipoIngrediente.label" default="Tipo Ingrediente" /></th>
					
						<th><g:message code="ingrediente.tipoMedida.label" default="Tipo Medida" /></th>
				...
				<g:each in="${ingredienteInstanceList}" status="i" var="ingredienteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: ingredienteInstance, field: "tipoIngrediente")}</td>
					
						<td>${fieldValue(bean: ingredienteInstance, field: "tipoMedida")}</td>
			...
			<div class="pagination">
				<g:paginate total="${ingredienteInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
